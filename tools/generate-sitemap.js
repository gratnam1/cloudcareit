...
const staticRoutes = [
  ...
  { path: '/ai-integration', priority: '0.80', changefreq: 'monthly' },
  ...
  { path: '/guides/security/network-attacks/port-scanning-risk', priority: '0.72', changefreq: 'monthly' },
  { path: '/guides/security/network-attacks/remote-exploitation-attacks', priority: '0.72', changefreq: 'monthly' },
  { path: '/guides/security/network-attacks/man-in-the-middle-attacks-small-business', priority: '0.72', changefreq: 'monthly' },
  { path: '/guides/security/network-attacks/rogue-wifi-risk', priority: '0.72', changefreq: 'monthly' },
  ...
  { path: '/guides/security/network-attacks/dns-attack-risk-small-business', priority: '0.72', changefreq: 'monthly' },
  { path: '/guides/security/network-attacks/lateral-movement-risk', priority: '0.72', changefreq: 'monthly' },
