...
export default {
  async fetch(request, env) {
    ...
    // directory indexes when called from inside a Worker — it can return 307 redirects
    // back to the browser, causing redirect loops. Explicitly requesting /path/index.html
